...
run_relay_tutorial() {
	...
	expected_install=$'curl -fsSL https://raw.githubusercontent.com/registrystack/registry-stack/refs/tags/v0.12.1/crates/registryctl/install.sh | REGISTRYCTL_VERSION=v0.12.1 bash\nregistryctl --version'
	...
	assert_contains "$LAST_OUTPUT" 'registryctl 0.12.1'
