...
export const starterFiles = [
  ...
  'offline-starter/README.md',
  'offline-starter/selectors/record-by-code-v1.yaml',
  'offline-starter/sources/record-status.yaml',
  'offline-starter/queries/record-status.sql',
  'offline-starter/adapters/record-status-extract.rhai',
  'offline-starter/schemas/record-status-response.schema.yaml',
  'offline-starter/schemas/record-status-facts.schema.yaml',
  'offline-starter/questions/record-active.yaml',
  'offline-starter/derivations/record-active.rhai',
  'offline-starter/fixtures/record-active.yaml',
  'offline-starter/targets/local/settings.yaml',
