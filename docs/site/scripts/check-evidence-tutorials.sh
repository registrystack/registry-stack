...
EXCLUDED_EVIDENCE_TUTORIALS=(
	...
	first-registry-server                            # Server source preview; product CI runs quickstart/run.sh --smoke, reader execution checks the documented steps
	...
	review-registry-changes                         # Registry Server source-preview journey; verify page commands in reader mode, outside the Evidence runner
