...
test('v0.15 release-form docs stay distinct from published v0.13 and current-source evidence', async () => {
  ...
  assert.match(registryctlLead, /This page describes `registryctl 0\.15\.1`/);
  ...
  assert.match(tutorial, /uses Registryctl 0\.15\.1 and its matching release material/);
  ...
  assert.match(tutorial, /Starter: http \(Registry Stack 0\.15\.1\)/);
