...
- Mount the governed `bundle/` directory and every artifact inside it, `runtime.yaml`, and each
  named CA bundle file read-only and non-writable to the service process, and keep the secret root
