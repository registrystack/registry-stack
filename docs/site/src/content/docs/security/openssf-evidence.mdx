...
| Release artifacts | Checksums, image digests, image SBOMs, vulnerability scans, release capsules | Published since `v0.8.0`; signature assets are release-workflow gated |
