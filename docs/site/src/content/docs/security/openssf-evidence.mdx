...
| Provenance attestations | Release-level SLSA provenance for non-signature GitHub Release assets | Workflow enabled; as of 2026-07-09, `v0.8.3` and `v0.8.4` both include provenance |
