...
OID4VCI bootstrap routes, credential-status reads, and Relay provenance support routes may be
public because they do not return record or claim results on their own.
