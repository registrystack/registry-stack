...
Umami records page views, referral sources, general browser and device information, approximate
location, documentation feedback, and selected outbound-link clicks.
Page URLs may include query parameters.
