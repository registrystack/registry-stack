...
- Added the `v0.11.0` archived docset while retaining the v0.10.0 and earlier
  archives. The public release inventory remains eight artifacts. The optional
  language server, VS Code preview, and Zed preview remain source-installed
  developer tools, not release or marketplace artifacts.
