...
| How do the services run together in a local demo? | [Registry Lab](https://github.com/registrystack/registry-stack/blob/v0.9.0/lab/README.md) |
...
- Registry Relay source code or runtime internals. Registry Notary calls Registry Relay over
  ...
  {/* Evidence: the registry_data_api HTTP source connector is SourceConnectorKind::RegistryDataApi,
       crates/registry-notary-core/src/config.rs:6353-6360 at tag v0.9.0; no registry-relay
       dependency appears in any registry-notary* Cargo.toml, while registry-platform-* deps do,
       crates/registry-notary-server/Cargo.toml:22-34 at tag v0.9.0. */}
...
- Production deployment guidance. The demo uses CSV, XLSX, and Parquet fixtures and demo-grade
  ...
  {/* Evidence: "pre-1.0 technical release for evaluation and integration pilots",
       lab/README.md:3-5 at tag v0.9.0; synthetic CSV, XLSX, and Parquet fixtures,
       lab/README.md:659-670; demo credentials, lab/README.md:707-728; projects.yaml,
