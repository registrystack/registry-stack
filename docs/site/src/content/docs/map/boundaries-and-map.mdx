...
<figure>
  <img src="../../images/registry-family-map.svg"
       alt="Four formal Registry Stack products, with Registry Mint as a supporting service and the
            ...
            registry sources. Evidence Gateway answers one bounded question about one subject with a signed
            assertion. Registry Mint issues the short-lived access tokens Evidence Gateway verifies. Solmara
            Solmara Lab is an external synthetic-data adopter demo." />
</figure>
...
- Assertion evaluation, disclosure, and signing owned by Evidence Gateway. Registry Relay can declare
  evidence offerings, but requirement evaluation, disclosure form, source access, and signing run
  independently in Evidence Gateway.
