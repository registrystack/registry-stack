...
| --- | --- | --- | --- | --- | --- | --- |
| `--sd-jwt-vc-presentation <SD_JWT_VC_PRESENTATION>` | Yes | No | n/a | n/a | n/a | Stored compact SD-JWT VC presentation file |
| `--jwks <JWKS>` | Yes | No | n/a | n/a | n/a | Pinned trusted JWKS document. This file is the complete trust set |
| `--policy <POLICY>` | Yes | No | n/a | n/a | n/a | Holder-bound relying-procedure verification policy document |
| `--at <AT>` | No | No | n/a | n/a | n/a | Verification instant as strict RFC 3339 UTC; system time by default |
