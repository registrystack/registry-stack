...
| --- | --- | --- | --- | --- | --- | --- |
| `--jws <JWS>` | No | No | n/a | n/a | n/a | Stored flattened JWS JSON response file |
| `--sd-jwt-vc <SD_JWT_VC>` | No | No | n/a | n/a | n/a | Stored compact SD-JWT VC response file |
| `--jwks <JWKS>` | Yes | No | n/a | n/a | n/a | Pinned trusted JWKS document. This file is the complete trust set |
| `--policy <POLICY>` | Yes | No | n/a | n/a | n/a | Relying-procedure verification policy document |
