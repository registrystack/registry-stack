...
| `--expect <JSON_FILE>` | No | n/a | n/a | n/a | With --action and --input, assert exact synthetic effects or a declared refusal without printing values. A symbolic link at any component of this path is refused. |
