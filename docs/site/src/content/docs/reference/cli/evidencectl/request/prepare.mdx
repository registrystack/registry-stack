...
| --- | --- | --- | --- | --- | --- | --- |
| `<QUESTION>` | Yes | No | n/a | n/a | n/a | Question defined by the active local project |
...
| `--subject <SUBJECT>` | Yes | Yes | n/a | n/a | n/a | Subject selector. Repeat role:field=value for a multi-subject question |
