...
replacement fails, it attempts to restore the previous three-binary set. Checksum verification does
...
| `EVIDENCECTL_INSTALL_DIR` | Directory that receives the three binaries. | Defaults to `~/.local/bin`. |
