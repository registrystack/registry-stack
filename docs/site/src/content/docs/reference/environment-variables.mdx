...
Relay resolves secrets through two providers, environment and file, rooted at the directory holding the runtime file. One field takes a reference: `cursor.integrityKeyRef`, which applies when the deployment enables cursors.
