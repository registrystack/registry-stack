...
The fixed variable names above are transcribed from the binaries and the registryctl source. For the canonical definitions, read the [Registry Notary binary entry point](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-notary-bin/src/main.rs), the [Registry Relay binary entry point](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/src/main.rs), and the [registryctl library source](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registryctl/src/lib.rs). The operator-named secret variables are documented in the [Registry Notary operator config reference](../../products/registry-notary/operator-config-reference/) and the [Registry Relay configuration reference](../../products/registry-relay/configuration/).
