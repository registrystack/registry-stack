...
[Evidence](../../products/registry-evidence/) owns signed assertions and the public verification keys it serves at `/.well-known/evidence/jwks.json`.
...
A client that needs a signed, minimum-disclosure answer calls Evidence directly instead of following a Relay evidence offering.
