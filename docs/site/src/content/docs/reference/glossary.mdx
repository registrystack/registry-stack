...
<dl class="glossary-dl">
  ...
  <dt>Registry Lab</dt>
  <dd>Compose-based runnable local demo of Registry Relay, Registry Notary, shared platform services, synthetic fixtures, and narrated clients. Repo slug: `registry-lab`.</dd>
