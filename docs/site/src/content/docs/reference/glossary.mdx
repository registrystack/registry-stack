...
<dl class="glossary-dl">
  ...
  <dd>A decision already made and owned by an authoritative source system. Registry Notary may attest this fact only when the claim name and description identify it as source-owned; Notary does not recompute the decision or claim ownership of its policy.</dd>
