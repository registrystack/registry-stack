...
Lookup reference for the HTTP API a compiled Base Registry Engine package serves and for the events
...
[deploy and operate a registry](../../operate/breg/).
...
{/* Evidence: crates/registry-breg/src/query.rs, ParsedReadQueryMode;
...
{/* Evidence: crates/registry-breg/src/query.rs, parse_filter(), MAX_SELECTED_FIELDS, MAX_IN_VALUES, MAX_FILTER_PREDICATES, MAX_FILTER_DEPTH, MAX_FILTER_NODES, MAX_LITERAL_BYTES, MAX_OPAQUE_VALUE_BYTES, MAX_QUERY_PAYLOAD_BYTES, and MAX_BBOX_PARAMETER_BYTES;
    crates/registry-breg/src/api/mod.rs, MAX_TOP. */}
...
BReg format, not a CloudEvents signing standard.
...
- [Deploy and operate a registry](../../operate/breg/) for runtime configuration, receivers, replay, and erasure.
- [Author a registry project](../../configure/breg/) for entities, profiles, change requests, and actions.
- [Configuration reference](../breg-configuration/) for every project, module, and runtime key.
