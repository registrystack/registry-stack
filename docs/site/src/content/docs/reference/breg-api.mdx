...
{/* Evidence: crates/registry-breg/src/webhook.rs, claim(), finalize(), replay(), verify_retained_bindings(), WebhookDeliveryService, and WebhookDeliveryStatusKind;
    crates/registry-platform-hooks/src/delivery/service.rs, delivery_idempotency_key();
