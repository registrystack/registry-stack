...
The codes above are transcribed from the error taxonomies in the owning repos. For the canonical definitions, read the [Registry Notary `EvidenceError` taxonomy](https://github.com/registrystack/registry-stack/blob/v0.8.4/crates/registry-notary-core/src/error.rs) and the [Registry Relay error taxonomy](https://github.com/registrystack/registry-stack/blob/v0.8.4/crates/registry-relay/src/error.rs).
