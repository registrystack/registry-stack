...
For the v0.12.2 source definitions, read the
[Registry Notary `EvidenceError` taxonomy](https://github.com/registrystack/registry-stack/blob/v0.12.2/crates/registry-notary-core/src/error.rs)
and the
[Registry Relay error taxonomy](https://github.com/registrystack/registry-stack/blob/v0.12.2/crates/registry-relay/src/error.rs).
