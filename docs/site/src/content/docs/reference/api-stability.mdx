...
the `client_credentials` grant with registered authentication, `private_key_jwt` (RFC 7523) by
default or an explicitly selected standard client-secret method, the collapse of every client
