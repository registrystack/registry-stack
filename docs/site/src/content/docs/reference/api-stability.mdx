...
of truth: if this page and the artifact disagree, the artifact wins and this page must be
corrected.
...
| Registry Manifest schema and rendered artifacts | `registry-manifest/v1` and the rendered artifact schema versions, governed by [RS-DM-MANIFEST](../../spec/rs-dm-manifest/) | `validate_manifest` accepts only `registry-manifest/v1`; REQ-DM-MANIFEST-013 defines the additive-evolution rule |
