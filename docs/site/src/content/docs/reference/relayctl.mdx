...
tests in `crates/registry-relayctl/tests/cli_contract.rs`, at release v0.20.0. The generated exact
syntax is published only after its source version receives a recorded human review.
