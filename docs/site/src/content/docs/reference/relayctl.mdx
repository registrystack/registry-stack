...
the boundary tests in `crates/registry-relayctl/tests/cli_contract.rs`. Use the
[generated relayctl syntax](../cli/relayctl/) for exact command, argument, option, and constraint data.
