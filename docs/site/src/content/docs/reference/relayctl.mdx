...
[`release/VERIFY.md`](https://github.com/registrystack/registry-stack/blob/v0.33.0/release/VERIFY.md)
before running it.
...
The binary lands at `target/release/relayctl`. A macOS source build also requires CMake and Go for
