...
description: Reference for the Relay adopter command line, covering project initialization, schema inspection, validation, artifact generation, fixtures, change classification, sealed packaging, and editor integration.
status: current
owner: registry-docs
source_repos:
  - registry-stack
