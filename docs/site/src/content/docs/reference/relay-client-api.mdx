...
authentication, Problem, trace, and response validation in Rust. Server has a separate Rust client
and transport documented in the [Server client API reference](../registry-server-client-api/).
...
- [Server client API reference](../registry-server-client-api/) for the separate Registry Server client.
