...
{/* Evidence: crates/registry-server/src/request_workflow.rs, RequestState;
    crates/registry-server/src/mutation/request.rs, action_requires_request_owner();
    crates/registry-server/src/api/mod.rs, request_action_dispatch() and planner_failure_problem();
...
request log only; see [Scrape metrics](../../operate/registry-server/#scrape-metrics).
