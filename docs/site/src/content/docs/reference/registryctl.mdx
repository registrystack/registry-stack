...
The command tree, subcommands, and flags above come from the registryctl source. For the canonical definitions, read the [registryctl command tree in `src/main.rs`](https://github.com/jeremi/registry-registryctl/blob/v0.2.1/src/main.rs).
