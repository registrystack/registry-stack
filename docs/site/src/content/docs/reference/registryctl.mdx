...
This page describes `registryctl 0.15.0`. Use the binary, installer, image
...
Registryctl 0.15.0 keeps the pre-1.0 `init relay` scaffold retired. The
...
This reference describes Registryctl 0.15.0. The
