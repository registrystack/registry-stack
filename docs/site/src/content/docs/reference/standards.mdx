...
- The Verifiable Credentials Data Model (W3C VC) is listed as `aligns_with` (`referenced`).
  Registry Notary, the retired product that issued SD-JWT VC credentials under this alignment,
  never emitted a full W3C VC Data Model envelope. [Registry Relay](../../products/registry-relay/)
