...
- **Evidence-offering discovery.** Relay publishes evidence-offering metadata at
  ...
  The routes still exist, but runtime binding accepts only `access.kind: registry-notary`, and
  Registry Notary is retired. A new deployment should declare no evidence offering. Relay never
