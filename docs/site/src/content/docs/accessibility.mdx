...
The design decisions that back these targets are in `design-registry-docs.md`, the visual
design document for this site (maintained alongside the repository, not published separately).
