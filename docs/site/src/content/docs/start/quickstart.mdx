...
[Get a credential from the hosted lab](../credential-tour/). For how these connect to the rest of
...
- [Get a credential from the hosted lab](../credential-tour/): continue in the same hosted lab and
  see Registry Notary issue a privacy-preserving credential.
