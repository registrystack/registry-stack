...
Registry Notary has been retired. The
[retirement decision](../../decisions/notary-retirement-2026-08-03/) records
the boundary between that historical product and the supported paths above.
