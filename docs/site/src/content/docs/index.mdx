...
records from an existing source, and Base Registry Engine provides a configuration-defined
writable registry backed by PostgreSQL.
...
models, not built-in BReg types.
