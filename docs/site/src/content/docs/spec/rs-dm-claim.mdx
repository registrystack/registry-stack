...
description: "The data model for a Registry Notary claim definition: identity, inputs, source bindings, matching policy, rule, disclosure policy, render formats, and credential eligibility."
status: draft
owner: registry-docs
source_repos:
  - registry-notary
