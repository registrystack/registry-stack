...
| 1.0.1 | 2026-09-25 | draft | Replaced the audit chain integrity scope note with the audit envelope structure, since Relay audit entries are not chained. |
...
- Security model internals: token verification, audit envelope structure, and cursor key handling belong to [RS-SEC-G](../rs-sec-g/).
