...
description: "The cross-cutting security model for the registry stack: shared security primitives, authentication and authorization, verification-key publication, audit, federation trust, replay protection, and the operator boundary."
status: draft
owner: registry-docs
source_repos:
  - registry-platform
