...
| 0.3.0 | 2026-07-07 | draft | Rewrote REQ-DM-MANIFEST-013 from the additive-evolution rule to strict unknown-key rejection at parse time, and updated the runtime-binding-exclusion limitation and conformance statement to match (issue #249, issue #285). |
