...
Evidence is a separate product from Registry Relay.
It is the Evidence counterpart to [RS-PR-RELAY](../rs-pr-relay/), and it is not a Registry Relay
...
{/* RS-ARC-G 0.6.0 places Evidence in the architecture as its own component and states its
...
| 0.2.0 | 2026-08-04 | draft | Registry Notary is retired. Removed the RS-PR-NOTARY relationship statements and the `registry-notary*` dependency prohibition, and recorded that RS-ARC-G 0.6.0 now places Evidence in the architecture. |
...
Registry Relay's protocol is specified by RS-PR-RELAY; it does not govern Evidence, and Evidence
