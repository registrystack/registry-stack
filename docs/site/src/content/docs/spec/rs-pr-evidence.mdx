...
public or federated catalogs, runtime bundle mutation, source planning, multi-source fulfillment,
...
`products/evidence/generated/registry-evidence.openapi.json`: one singular evidence operation, one
multi-subject request-batch operation, one definition-discovery operation, public key discovery,
