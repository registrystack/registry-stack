...
{/* Evidence: AccessRule is Public | Protected{scope, purpose, authorityRowBinding} and
     AuthorityRowBinding has a claim variant and a principal variant,
     crates/registry-relay-v2/src/contract.rs:947-976; row authority is injected as a bound
