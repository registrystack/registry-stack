...
whether a presence or allow-list check was applied. They must not expose source tokens, subject
identifiers, selectors, raw records, consent values, or authorization details.
