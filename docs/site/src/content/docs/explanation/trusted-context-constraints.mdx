...
Subject access constrains the authenticated requester and subject. It does not
replace the Relay observation contract or provide claim evidence.
...
- Does every claim retain a compiler-pinned Relay observation contract?
