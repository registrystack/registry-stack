...
Use this page as a checklist before you commit. If a limit below is a dealbreaker for your deployment, better to find that out before integrating than after.
...
For the rationale behind each of these, follow the linked specifications in the sections below.
