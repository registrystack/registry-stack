...
Clinical health systems can expose bounded outputs through a reviewed FHIR integration, public-health
...
evidence lookup.
The logical records definition stays in the project workspace; provider paths, worksheets, tables,
...
OpenCRVS, DHIS2, OpenSPP, and jurisdiction-specific systems remain authored integrations rather than
