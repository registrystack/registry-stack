...
or self-attested claims. In a combined project, Relay keeps source credentials and returns only
...
<figure>
  <img src="../../images/registry-country-evidence-mesh.svg"
       alt="Country evidence mesh: civil registration, clinical health over FHIR API,
            ...
            only, source-free Notary only, or both. Relay returns governed typed outputs, combined
            projects turn consultation outputs into minimized claims, and the social protection MIS
