...
Two runtime patterns carry these principles, Registry Relay and Evidence, and each enforces them
...
Minimization also applies to what leaves the boundary. Evidence has no caller-selectable
