...
[Configure a Casework project](../../configure/casework/) carries the grammar for routing rules, calendars, and clocks.
...
- Casework issues no tokens and stores no users. Identity belongs to your OpenID Connect provider, or to Registry Mint when you have none.
...
- [Configure a Casework project](../../configure/casework/): hosted kinds, sources, routing rules, calendars, and clocks.
