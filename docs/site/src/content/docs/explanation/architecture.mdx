...
<figure>
  <img src="../../images/registry-architecture-flow.svg"
       alt="Architecture flow: Registry Platform provides shared primitives. Registry Manifest compiles
            ...
            Registry Notary evaluates claims from compiler-pinned Relay consultations and issues credentials
...
5. Registry Relay executes compiler-pinned consultations. Its product-neutral `http`, `script`,
   ...
   outputs. Registry Notary evaluates evidence claims from those Relay outputs. Caller identity
   and authorization details can authorize or parameterize a request but cannot supply evidence. It renders evaluation
   results as
