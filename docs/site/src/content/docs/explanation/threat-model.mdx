...
**Audit as a control.** Evidence Gateway writes two mandatory records per request: an access-attempt
...
- Key custody is not certified by health checks: Readiness, liveness, and offline validation
  ...
  requires. They do not certify production-grade custody. Evidence Gateway Version 1 has one secret
