...
and neither inherits the other's decisions. Evidence Gateway contacts its own configured
authoritative HTTP sources; Relay reads its own local SQLite file and contacts nothing. Each
