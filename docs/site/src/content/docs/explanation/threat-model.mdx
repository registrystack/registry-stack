...
<figure>
  <img src="../../images/registry-trust-boundaries.svg"
       alt="The Registry Stack trust boundaries in one map. One request path runs from Registry Mint,
            ...
            credential, TLS, projection, and redirect and proxy denial, and a statement source fixes
...
{/* Evidence: AuthenticationRuntime carries only an optional issuer,
     ...
     principal for Protected, crates/registry-relay-v2/src/auth.rs. */}
...
- Secret material in deployment configuration: Relay holds no source credential, because its
  ...
  does exist, and the bundle names it by logical secret reference rather than writing it inline.
