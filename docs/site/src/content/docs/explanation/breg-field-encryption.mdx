...
{/* Evidence: crates/registry-platform-crypto/src/field_encryption.rs, seal_field(),
    ...
    FieldEncryptionService::open(); crates/registry-breg/src/mutation.rs,
    encrypted_column_values() and enforce_field_pattern();
...
{/* Evidence: crates/registry-breg/src/problem.rs, RuntimeFieldEncryptionUnavailable;
