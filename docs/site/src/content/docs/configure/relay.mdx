...
Start an institutional statistical project from
`products/relay-v2/acceptance/labour-statistics`. The tracked acceptance project owns the complete
configuration, synthetic snapshot, codelists, expected HTTP exchanges, and generated baselines.
