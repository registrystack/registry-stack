...
{/* messaging-s6b: once messagingctl dev exists, point readers at the local tutorial before this page. */}
...
{/* messaging-s6b: state how requestsPerMinute, burst, and dailyLimit are enforced (429 rate-limit.exceeded, 429 quota.exceeded) once enforcement lands. */}
...
| `capabilities.ratePerSecond` | Optional, 1 to 1000 |
