...
presentation verifies again under the same policy. Walk the whole path in
[Request a holder-bound credential](../../tutorials/request-a-holder-bound-credential/).
...
requirement to the SD-JWT VC serialization and its batch envelope. See
[Request a holder-bound credential](../../tutorials/request-a-holder-bound-credential/).
