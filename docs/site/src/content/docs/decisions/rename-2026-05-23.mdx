...
Docstrings and comments are residual and could be updated to say "[Registry Lab](https://github.com/registrystack/registry-stack/tree/v0.9.0/lab) demo"
...
and any affected source links in `src/data/contracts.yaml` and `src/data/standards.yaml`.
