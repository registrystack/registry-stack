...
{/* TODO[evidence]: Confirm whether registry-relay has absorbed Phase 4 contract changes:
     ...
     (2) access.kind "evidence-server" replaced with "registry-notary" in openapi.rs and validate.rs,
...
Docstrings and comments are residual and could be updated to say "[Registry Lab](https://github.com/registrystack/registry-stack/tree/v0.8.3/lab) demo"
