...
| --- | --- |
| `remote-uncertain`, `cancellation-uncertain`, `source-precondition-changed` | Wait through `application.nextAttemptAt` where present and re-read the request. The durable worker retries automatically. |
