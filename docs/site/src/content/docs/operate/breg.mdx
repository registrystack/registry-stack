...
[release verification](https://github.com/registrystack/registry-stack/blob/v0.26.0/release/VERIFY.md)
...
The release publishes the installer as `breg-v0.26.0-install.sh`, with `breg-install.sh` as the
movable alias, and the binaries as `breg-v0.26.0-linux-amd64`, `breg-v0.26.0-linux-arm64`,
`breg-v0.26.0-macos-arm64`, `bregctl-v0.26.0-linux-amd64`, `bregctl-v0.26.0-linux-arm64`, and
`bregctl-v0.26.0-macos-arm64`.

The container image is `ghcr.io/registrystack/breg:v0.26.0`, built on distroless nonroot. Its
