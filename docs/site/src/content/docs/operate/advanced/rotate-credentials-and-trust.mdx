...
1. Prepare a fresh output directory and rotate the affected product anchor with:
   ...
   anchor in place.
2. Review and distribute the transition through the affected product's governed deployment path.
   Do not add an ungoverned signer directly to a deployed anchor.
3. Accept the rotated anchor through that product's governed deployment process and restart staged
   instances.
