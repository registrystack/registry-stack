...
are accepted. Remove the compromised fingerprint immediately when another valid fingerprint
remains. Remove the complete registration when revoking the last or only secret, then reload;
