...
{/* TODO[review]: GH#203 requires this procedure to be exercised at least once against a
     real topology, with the run recorded under release/. That record does not exist yet;
     keep status: draft until it does and link it from the verification section. */}
