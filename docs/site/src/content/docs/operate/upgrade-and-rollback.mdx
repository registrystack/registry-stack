...
- Your deployment pins a version tag (`v0.10.0`) or an image digest, never `latest`.
...
- You can run the release-verification steps in
  [SECURITY.md](https://github.com/registrystack/registry-stack/blob/v0.10.0/SECURITY.md)
