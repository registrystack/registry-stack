...
| Series | Type | Labels |
| --- | --- | --- |
| `registry_server_http_requests_total` | counter | `route`, `method`, `status` |
| `registry_server_http_request_duration_seconds` | histogram | `route`, `method`, `status` |
| `registry_server_anonymous_refusals_total` | counter | `route`, `method`, `reason` |
| `registry_server_pool_connections` | gauge | `state`: `max_size`, `size`, `available`, `waiting` |
...
`registry_server_anonymous_refusals_total` counts requests that presented no credential and were
...
{/* Evidence: crates/registry-server/src/metrics.rs, AnonymousRefusalReason;
    crates/registry-server/src/api/mod.rs, anonymous_refusal();
    crates/registry-server/src/postgres/read.rs, record_pre_io_audit() call in execute();
    crates/registry-server/tests/postgres_anonymous_refusals.rs;
    crates/registry-server/src/runtime_config.rs, MetricsListenerConfig;
    crates/registry-server/src/startup.rs. */}
...
{/* Evidence: crates/registry-serverctl/src/lib.rs, DiffArgs, PackageCandidateArgs, and MigrationCommand;
    ...
    crates/registry-server/src/migration_reconcile.rs;
    crates/registry-serverctl/src/reconcile_lifecycle.rs;
    crates/registry-server/src/package.rs;
...
```sh
target/debug/registry-serverctl history rebaseline \
  --runtime-config /etc/registry-server/runtime.yaml \
...
{/* Evidence: crates/registry-server/src/history_rebaseline.rs;
    crates/registry-serverctl/src/history_rebaseline_lifecycle.rs;
    crates/registry-server/tests/postgres_history_rebaseline.rs. */}
