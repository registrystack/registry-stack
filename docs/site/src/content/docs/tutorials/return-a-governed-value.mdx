...
Complete [Issue your first Evidence assertion](../first-evidence-assertion/) before starting this
...
date of birth. Evidence will use it to answer both questions.
...
codelist enforced by the Evidence runtime.
...
The command compiles both files in `questions/` into the same local Evidence service. The adult
...
The source value `2000-01-01` is currently in the `25-to-64` category. The verified assertion
