...
`evidencectl new` retains the OpenAPI document and creates empty `sources/`, `questions/`, and
`derivations/` directories.
It also generates disposable local signing, audit, subject-binding, and Registry Mint key
material.
...
service account, review the source acquisition posture, and promote the governed bundle.
