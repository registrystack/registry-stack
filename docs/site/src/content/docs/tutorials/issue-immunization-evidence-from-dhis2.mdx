...
request:
  ...
  pathBindings:
    uid: {role: child, profile: child-tracked-entity-v1, field: tracked_entity_id}
  fixedHeaders:
    - name: Accept
...
Evidence validates the projected response before extraction runs, and every array in a schema
