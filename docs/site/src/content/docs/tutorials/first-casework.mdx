...
```sh
umask 077
caseworkctl dev token tutorial-work/casework requester
```
...
```sh
caseworkctl dev token tutorial-work/casework staff
```
...
```sh
caseworkctl dev token tutorial-work/casework supervisor
```
...
Run `caseworkctl dev token tutorial-work/casework <client>` again; it replaces that client's header file.
