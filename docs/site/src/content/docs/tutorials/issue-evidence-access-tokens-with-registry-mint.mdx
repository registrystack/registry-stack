...
Generate Mint's signing key independently from Evidence Gateway's signing key. Keep it owner-only outside
the Evidence Gateway candidate.

## Author Mint separately

Create a Mint directory beside, not inside, the Evidence Gateway candidate:
...
Register each client with its public JWK, reviewed principal, requester tags, Evidence Gateway audience,
...
principal, requester-tags, Evidence Gateway audience, grant-id, grant-authority, and optional actor claim
