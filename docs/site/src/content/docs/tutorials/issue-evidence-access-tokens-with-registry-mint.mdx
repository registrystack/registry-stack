...
Use Registry Mint when your deployment has no suitable OpenID Connect (OIDC) issuer for Evidence.
Mint is a separate supporting service. Evidence does not require Mint, and an external HTTPS OIDC
issuer follows the same Evidence authentication contract.
