...
Build one editable Evidence project from an institution's OpenAPI document. The progression uses
the same retained contract for source drafting and local execution. You do not assemble a
deployment bundle or copy a reference deployment.
