...
tutorial_test:
  toolset: evidence
  skip: drift-checked by evidence-production-build-docs.test.mjs; needs Docker Compose
---
...
adapter, not output from `evidencectl package`. The candidate bundle stays unchanged across host and
