...
<QuickstartMeta
  outcome="An approved Evidence Gateway candidate mounted unchanged with a separate runtime, secret root, and persistent audit volume."
  time="About 20 minutes after the image and candidate are approved"
  level="Operator-owned Docker Compose deployment"
  prerequisites={['Docker Compose', 'An approved Evidence Gateway candidate', 'A reviewed Evidence Gateway image', 'Persistent storage prepared for UID and GID 65532']}
/>
