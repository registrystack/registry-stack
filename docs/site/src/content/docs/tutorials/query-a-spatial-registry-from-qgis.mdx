...
first runs Base Registry Engine and Registry Mint, while the second performs the refresh write.
...
The first run builds Base Registry Engine, `bregctl`, and Registry Mint. It also downloads
...
BReg does not claim full Open Geospatial Consortium API Features conformance.
