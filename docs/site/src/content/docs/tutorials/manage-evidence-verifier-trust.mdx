---
title: Manage Evidence verifier trust
...
Keep that decision outside the Evidence response. Discovery helps you find candidate metadata; it
...
- the expected Evidence service and JWKS endpoints;
- the Ed25519 public keys and their `kid` values;
- the audience that identifies your relying service;
...
still have a valid assertion in circulation. The provider should retain retiring public keys for
...
Provider operators use [Move Evidence to production signing](../move-evidence-to-production-signing/)
