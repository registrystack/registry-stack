---
title: See Evidence refuse unsafe requests
...
You will reuse that project to observe two boundaries: Evidence denies a purpose the provider did
...
authorization for that exact authority path.
