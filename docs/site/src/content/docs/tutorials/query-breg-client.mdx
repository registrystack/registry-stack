...
[Base Registry Engine client API reference](../../reference/breg-client-api/#error-contract) names
...
- [Base Registry Engine client API reference](../../reference/breg-client-api/) for every method, outcome shape, and error kind.
