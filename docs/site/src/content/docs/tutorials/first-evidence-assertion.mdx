...
and disclosure fields permit one boolean named `is_adult`.
...
the date against which the eighteenth birthday is compared. The function returns only the boolean
