...
Register one local client that may ask this question, then create the small application-owned client
profile used by all three request paths:
...
{/* The v0.20.0 Python and Node.js assets are intentionally unavailable until that release is published. */}
