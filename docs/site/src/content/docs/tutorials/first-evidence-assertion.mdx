...
The command creates owner-only local keys for signing, subject binding, and audit pseudonyms.
...
Stop Evidence Gateway and the local issuer before reading the completed audit log:
...
Show the last operation in the completed audit log:
