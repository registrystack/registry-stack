...
`init` writes a project for `bregctl dev`, so its `package` block names `local`, the unsigned
environment. A candidate is built for a named environment and must be signed. Open
`tutorial-work/candidate-project/registry.yaml` and change the `environment` line in that block:
...
The runtime configuration and the trust anchor you write later name the same environment.
...
page come from the `bregctl init` project with only that environment change; if you edit anything else
in `candidate-project`, yours differ, and that is expected.
...
```text
check succeeded
revision: sha256:47bb7234a81ecd44fef51323c6d92f3291282b5faebb6645a9096f16b9059d5a
...
test succeeded
profile: production
package revision: sha256:d2886ea2006498adbefd77479e4a40186eada60dbaeeee572d6edeaacee6c3dc
schema fingerprint: sha256:d459608ae9792a4bc387ff3965652ead7a7a1ac2ffa11b81506b55c66ebc6c02
signing input sha256: 248a359554982daa7e0ee627027acda85394b9c3154facbf60c821c6596952ee
successful journeys: record-lifecycle
receipt sha256: c8e518182c09c45c620163d2fe5b71d1cbcaae7581356c15944e000aff96c9cf
receipt bytes: 1054
```
...
registry revision: sha256:47bb7234a81ecd44fef51323c6d92f3291282b5faebb6645a9096f16b9059d5a
modules: 1
entities: 2
routes: 8
access entries: 8
