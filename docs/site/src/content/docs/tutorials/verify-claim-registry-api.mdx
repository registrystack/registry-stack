...
<QuickstartMeta
  ...
  prerequisites={['The my-first-api project from the first tutorial', 'Matching Registry Stack v0.12.0 registryctl, release images, and image lock', 'A Docker Compose provider', 'curl']}
/>
...
the same Registry Stack `v0.12.0` release. Do not combine a source-built CLI with images or an
