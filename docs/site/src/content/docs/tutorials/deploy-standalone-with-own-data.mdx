...
[Relay operations runbook](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/ops.md)
...
[security assurance notes](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/security-assurance.md)
and the [build and release section](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/ops.md#build-and-release)
...
[build and release section](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/ops.md#build-and-release)
...
[`config/example.yaml`](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/config/example.yaml)
and the
[configuration guide](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/configuration.md),
...
The [API keys section](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/configuration.md#api-keys)
...
[readiness and probes section](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/ops.md)
...
The
[Operating with Registry Notary section](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/ops.md#operating-with-registry-notary)
...
- [Relay configuration guide](https://github.com/registrystack/registry-stack/blob/v0.8.0/crates/registry-relay/docs/configuration.md):
