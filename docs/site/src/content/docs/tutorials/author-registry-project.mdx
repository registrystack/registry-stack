...
Initialized Registry Stack project "fictional-citizen-registry".
  ...
  Starter: http (Registry Stack 0.12.0)
...
claim id and description must identify it as a source-owned decision and the integration must
preserve the source's exact meaning. Notary does not recompute the decision.
