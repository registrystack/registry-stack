...
evidence authorization and disclosure policy. The consuming programme keeps its eligibility,
prioritization, workflow, and action policy outside the project.

Test every proposed claim before adding it:

1. Does the claim state one atomic evidence fact or value, rather than a programme decision?
...
3. Can another authorized programme reuse the evidence without importing the first programme's
   eligibility, ranking, workflow, or action rules?
...
3. Under the consuming evidence service, add a consultation with
   ...
   consuming programme decisions outside the evidence service.
