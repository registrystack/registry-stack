...
This tutorial uses Registryctl 0.15.0 and its matching release material. Do not
...
<QuickstartMeta
  ...
  prerequisites={['registryctl 0.15.0 and its matching image lock', 'A shell and a text editor']}
/>
...
Initialized Registry Stack project "fictional-citizen-registry".
  ...
  Starter: http (Registry Stack 0.15.0)
