...
Evidence's V1 verifier checks the complete stored SD-JWT VC response. Wallet presentation, omission of
...
- [Prove an Evidence project](../prove-an-evidence-project/)
