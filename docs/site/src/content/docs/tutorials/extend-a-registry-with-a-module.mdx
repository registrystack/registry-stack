...
<QuickstartMeta
  ...
  prerequisites={[
    { label: 'The binaries and tutorial-work directory from Create and query your first registry', href: '/tutorials/first-breg/' },
    'An editor',
...
```yaml test-excerpt="tutorial-work/project/modules/record-notes/module.yaml"
version: 0.1.0
```
...
```yaml test-excerpt="tutorial-work/project/registry.yaml"
modules:
  - id: "record-notes"
    version: "0.1.0"
...
```diff lang="yaml" title="tutorial-work/project/registry.yaml" test-edit
...
In `module.yaml`, raise `version` to `0.2.0`:

```diff lang="yaml" title="tutorial-work/project/modules/record-notes/module.yaml" test-edit
-version: 0.1.0
+version: 0.2.0
```

and raise the field's `maxLength` to `1000`:

```diff lang="yaml" title="tutorial-work/project/modules/record-notes/module.yaml" test-edit
 fields:
-  - {id: internal-note, type: string, maxLength: 500, classification: internal}
+  - {id: internal-note, type: string, maxLength: 1000, classification: internal}
```
