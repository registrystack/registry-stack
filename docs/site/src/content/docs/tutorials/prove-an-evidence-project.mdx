...
fixtures. Fixtures are executable claims about your own Evidence project. They are not sample data
for a first run and they should not be generated from an unrelated domain.
