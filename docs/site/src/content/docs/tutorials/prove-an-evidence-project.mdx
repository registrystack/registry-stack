...
runtime file. [Build and deploy an Evidence Gateway project](../build-and-deploy-evidence-project/) covers
the target-host ceremony.

## Next

- [Verify an assertion as a consumer](../verify-an-assertion-as-a-consumer/)
- [Rotate Evidence Gateway signing keys](../move-evidence-to-production-signing/)
