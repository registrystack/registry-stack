...
The check succeeds, prints the compiled configuration's digest, and lists 26 findings under four
codes.
...
Authoring check passed.
  ...
  finding  access.profile.unrestricted_collection  10 paths
           ...
           registry-wide access
             entities[id=asset-item].accessProfiles[id=asset-operator].rowBoundaries
             entities[id=asset-item].accessProfiles[id=site-planner].rowBoundaries
             entities[id=asset-placement].accessProfiles[id=asset-operator].rowBoundaries
             entities[id=asset-placement].accessProfiles[id=correction-submitter].rowBoundaries
             entities[id=asset-placement].accessProfiles[id=site-planner].rowBoundaries
             entities[id=asset-site].accessProfiles[id=asset-operator].rowBoundaries
             entities[id=asset-site].accessProfiles[id=correction-submitter].rowBoundaries
             entities[id=asset-site].accessProfiles[id=site-planner].rowBoundaries
             entities[id=inspection-event].accessProfiles[id=asset-operator].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-reviewer].rowBoundaries
  finding  access.profile.unrestricted_rows  4 paths
           ...
           still apply. Review this registry-wide access
             entities[id=asset-item].accessProfiles[id=correction-submitter].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-applier].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-submitter].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-supervisor].rowBoundaries
  finding  access.target.unrestricted_rows  5 paths
           this target grant has no claim-bound row restriction, within its configured
           operation and field limits. Review this registry-wide target authority
             entities[id=asset-placement].accessProfiles[id=asset-operator].requestPresence[requestType=placement-correction-request].rowBoundaries
             entities[id=asset-placement].accessProfiles[id=site-planner].requestPresence[requestType=placement-correction-request].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-applier].applyTargets[entity=asset-placement].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-reviewer].reviewStages[stage=review].targets[entity=asset-placement].rowBoundaries
             entities[id=placement-correction-request].accessProfiles[id=correction-supervisor].reviewStages[stage=final-approval].targets[entity=asset-placement].rowBoundaries
