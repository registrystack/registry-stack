...
Authoring check passed.
  ...
  finding  access.profile.no_required_scope  entities[id=asset-item].accessProfiles[id=asset-operator].requiredScopes
           ...
           this is intended
  finding  access.profile.unrestricted_collection  entities[id=asset-item].accessProfiles[id=asset-operator].rowBoundaries
