...
Download and run the Registryctl 0.15.1 installer:
...
[release verification guide](https://github.com/registrystack/registry-stack/blob/v0.15.1/release/VERIFY.md)
