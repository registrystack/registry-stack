...
Download and run the Registryctl 0.15.2 installer:
...
[release verification guide](https://github.com/registrystack/registry-stack/blob/v0.15.2/release/VERIFY.md)
