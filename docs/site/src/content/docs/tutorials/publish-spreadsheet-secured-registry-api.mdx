...
`SHA256SUMS`. The pinned `v0.8.4` installer installs the binary; beginning with
`v0.9.0`, the matching installer installs the binary and release image lock. It
