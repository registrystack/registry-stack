...
`residency-confirmed`, rather than for a consuming programme decision such as
`benefits-eligible`. The consuming programme owns the eligibility and action rules.
