...
[evaluate a claim with Registry Notary](/journeys/registry-backed-notary-claim/). Clone Solmara Lab when you
...
- [Evaluate a claim with Registry Notary](/journeys/registry-backed-notary-claim/): add Notary to that local
  project.
