...
[evaluate a claim with Registry Notary](/tutorials/verify-claim-registry-api/). Clone Solmara Lab when you
...
- [Evaluate a claim with Registry Notary](/tutorials/verify-claim-registry-api/): add Notary to that local
  project.
