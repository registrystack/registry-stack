...
```yaml title="schemas/adult-assessment.yaml" test-file
...
```yaml title="questions/adult-assessment.yaml" test-file
id: adult-assessment
...
```rhai title="derivations/adult-assessment.rhai" test-file
