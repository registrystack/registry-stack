...
class CleanupReleaseCandidatesTest(unittest.TestCase):
    ...
    def test_casework_candidate_is_allowlisted_after_package_bootstrap(self) -> None:
    ...
    def test_scheduling_candidate_is_allowlisted_after_package_bootstrap(self) -> None:
    ...
    def test_breg_services_remain_publicly_denylisted_before_candidate_onboarding(
        self,
    ) -> None:
