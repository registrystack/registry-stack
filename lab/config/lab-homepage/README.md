...
secrets, source consultation tokens, signing keys, database credentials, live
...
shown on the page. The self-attested Notary API key is supplied by the hosted
deployment so its raw value stays aligned with the deployed fingerprint.
