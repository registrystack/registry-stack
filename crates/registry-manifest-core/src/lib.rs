...
impl<'de> Deserialize<'de> for MetadataManifest {
        ...
        D: Deserializer<'de>,
    {
        ...
        let fields: MetadataManifestFields =
            serde_path_to_error::deserialize(value).map_err(de::Error::custom)?;
        Ok(fields.into())
    }
}
...
fn jsonld_context() -> Value {
    let mut context = json!({
        ...
        "sh": "http://www.w3.org/ns/shacl#",
        "skos": "http://www.w3.org/2004/02/skos/core#",
        "registry_manifest": "https://id.registrystack.org/ns/registry-manifest/v1#",
        "xsd": "http://www.w3.org/2001/XMLSchema#",
        "adms:status": { "@type": "@id" },
