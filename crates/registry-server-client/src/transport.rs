...
use crate::{RegistryServerClientConfig, RegistryServerClientError, RegistryServerProtocolFailure};
...
impl Transport {
    ...
    pub(crate) fn url(&self, segments: &[&str]) -> Result<Url, RegistryServerClientError> {
