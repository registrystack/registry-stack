...
pub use project_authoring::{
    build_registry_project, build_registry_project_with_baselines,
    build_registry_project_with_baselines_and_context, build_registry_project_with_context,
    check_registry_project, check_registry_project_with_context,
    check_registry_project_with_trusted_local_authored_values, embedded_configuration_reference,
    embedded_configuration_reference_coverage, init_registry_project, inspect_project_capabilities,
    preflight_registry_project, redacted_project_check_failure_diagnostics,
    render_project_authoring_diagnostics, setup_registry_project_editor, test_registry_project,
    test_registry_project_selected, test_registry_project_selected_with_context,
    test_registry_project_with_context, ArtifactInputClassification, ArtifactInputDigest,
    AuthoredSemanticFixtureCoverage, CapabilityDisposition, CapabilityId,
    ...
    ProjectPreflightOptions, ProjectPreflightReportV1, ProjectPreflightSchemaVersion,
    ProjectRelativePath, ProjectSchemaKind, ProjectSemanticImpactReportV1, ProjectStarter,
    ProjectTestOptions, ProjectTestSelection, ProjectTrustedLocalAuthoredValue,
    ProjectTrustedLocalCheck, RedactionReason, ReferenceCoverageSummary, ReferenceSourceContract,
