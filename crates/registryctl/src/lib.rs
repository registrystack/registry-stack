...
pub use project_authoring::{
    ...
    test_registry_project_with_context, AuthoredSemanticFixtureCoverage, AuthoringContract,
    AuthoringVersionSet, CapabilityDisposition, CapabilityId, CapabilityInventoryEvidenceGrade,
    CapabilityInventoryRecord, CapabilityKind, CapabilityMaturity, CapabilityOwner,
    CapabilityUsageCounts, ClassifierSafeReportedValue, ConfigurationFieldReference,
    ConfigurationReferenceCoverageV1, ConfigurationReferenceV1, ConfigurationState,
    CoverageInvariant, CoverageStatus, DefaultBehavior, DefaultDocumentation,
    ...
    FixtureProtocolHelper, FixtureRequirementCoverage, FixtureSafeCode, FixtureSemanticExpectation,
