...
pub use project_authoring::{
    ...
    RuntimeActivationEvaluation, SchemaConstraint, SemanticChange, Sha256Digest,
    SourceAccessAssertion, SourceCallExpectation, StructuralIntent, SupportAssessment,
    SupportComponent, SupportEvidence, SupportKind, SupportState, SupportedCapabilityVersion,
    TrustResolutionAssessment, TrustResolutionInput, UnresolvedMigrationDecision, ValidationStage,
    VersionChange, VersionHistoryEntry, CONFIGURATION_REFERENCE_COVERAGE_SCHEMA_ID,
...
pub use project_authoring::{
    ...
    ProjectStarterSemanticComparisonOptions, SemanticComparisonAffectedSubject,
    SemanticComparisonAffectedSubjectKind, SemanticComparisonAssurance,
    SemanticComparisonChangeSource, SemanticComparisonConsumer, SemanticComparisonDimension,
    SemanticComparisonDirection, SemanticComparisonEquivalence, SemanticComparisonEvidenceGrade,
    SemanticComparisonEvidenceLimitation, SemanticComparisonExternalApproval,
    SemanticComparisonFieldAddress, SemanticComparisonGeneratedArtifact, SemanticComparisonKind,
    SemanticComparisonPrecision, SemanticComparisonRequiredAction, SemanticComparisonRequirements,
