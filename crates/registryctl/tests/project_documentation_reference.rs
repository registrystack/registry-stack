...
fn human_intent_sidecar_and_documentation_contracts_are_strict_schemas() {
    ...
    assert_eq!(intent["structural_reviews"].as_array().unwrap().len(), 217);
...
fn embedded_coverage_is_complete_and_generates_the_canonical_reference() {
    ...
    assert_eq!(coverage.coverage.path_count, 1838);
    assert_eq!(
        coverage.coverage.by_schema,
        [
            (ConfigurationSchemaKind::Project, 223),
    ...
    assert_eq!(
        ...
        [
            ...
            (FieldPathKind::Property, 1_455),
            (FieldPathKind::MapKey, 26),
            (FieldPathKind::MapValue, 48),
            (FieldPathKind::ArrayItem, 184),
    ...
    assert_eq!(coverage.reviewed_intent_assignment_required_count, 1838);
    assert_eq!(
    ...
    assert_eq!(coverage.reviewed_intent_assignment_covered_count, 1838);
    assert!(
