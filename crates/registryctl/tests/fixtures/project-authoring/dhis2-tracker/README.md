...
1. Relay performs the bounded DHIS2 request and normalizes four nullable typed
   outputs: programme enrollment active, BCG birth dose recorded, OPV birth
   dose recorded, and measles dose recorded.
