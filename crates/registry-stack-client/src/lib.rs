...
pub mod casework {
    pub use registry_casework_client::{
        ...
        HolidaySetDocument, HolidaySetRevisionInput, HostedAccountabilityRecord,
        HostedCancelRequest, HostedCreateRequest, HostedDecisionRequest, HostedHistoryEntry,
        HostedHistoryKind, HostedHistoryPage, HostedKindPolicy, HostedNote, HostedNotePage,
        HostedNoteRequest, HostedOutcomePolicy, HostedPageQuery, HostedTerminalPage,
        HostedTerminalQuery, HostedTerminalResult, HostedTerminalState, HostedValidationError,
        HostedValidationReason, HostedWorkItemContext, InboxView, IssuerPrincipal,
        ...
        SubjectClockCompletion, SubjectClockPause, SubjectRef, TeamRecord, Uuid, WorkItem,
