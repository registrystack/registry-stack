...
mod tests {
    ...
    #[test]
    fn audit_schema_names_the_governed_access_profile() {
        let context = AuditContext {
            operation_id: "operation-1".into(),
            trace_id: TraceId::parse("0123456789abcdef0123456789abcdef").expect("trace"),
            registry_identifier: "registry".into(),
            resource_identifier: Some("resource".into()),
            operation_identifier: Some("resource.search.within-bbox".into()),
            access_rule_revision: Some("sha256:access".into()),
            purpose: None,
            row_boundary_kind: RowBoundaryKind::None,
            access_profile: Some("public-premises".into()),
            disclosure_profile: Some("public-premises".into()),
            processing_description_identifiers: Vec::new(),
            selected_properties: vec!["premisesIdentifier".into()],
        ...
        assert_eq!(value["schema"], AUDIT_SCHEMA);
        assert_eq!(value["accessProfile"], "public-premises");
