...
// `__test__/drift.test.js`, against the real module. Keep this list explicit:
// generated loader diagnostics are not exported by client.js.
export {
  AudienceScopedResult,
...
export type {
  ...
  VerifiedEvidenceRequestBatchItem,
} from './index'
