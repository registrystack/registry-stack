        ...
        "properties": {
            "submission": {
                ...
                "properties": {
                    ...
                    "recoveryDeadline": {"type": "string", "format": "date-time", "maxLength": 128},
                    "policy": {
                        "type": "object",
                        "additionalProperties": false,
            ...
            "application": {
                ...
                "properties": {
                    ...
                    "nextAttemptAt": {"type": "string", "format": "date-time", "maxLength": 128},
                    "receiptRecovered": {"const": true}
                }
            },
            "recovery": {
                "type": "object",
