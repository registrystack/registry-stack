...
//! Bounded Base Registry Engine history snapshot references.

use std::fmt;

use uuid::Uuid;

const SNAPSHOT_REFERENCE_PREFIX: &str = "breg1_";
const SNAPSHOT_REFERENCE_BYTES: usize = 42;
...
mod tests {
    ...
    fn snapshot_reference_is_strictly_versioned_and_canonical() {
        ...
        assert!(SnapshotReference::parse("breg1_018FEAA0-68F9-4A45-B9E3-58436DF07AF7").is_err());
        assert!(SnapshotReference::parse("breg2_018feaa0-68f9-4a45-b9e3-58436df07af7").is_err());
    }
}
