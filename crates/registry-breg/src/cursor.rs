...
//! Base Registry Engine-owned confidential keyset cursor codec.
...
const CURSOR_AAD: &[u8] = b"breg-cursor-v3";
const AEAD_LABEL: &[u8] = b"breg-cursor-aead-key-v3";
const BINDING_LABEL: &[u8] = b"breg-cursor-binding-key-v3";
