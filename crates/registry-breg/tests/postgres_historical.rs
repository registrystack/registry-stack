...
use registry_breg::history_schema::{serialize_descriptor, HistorySchemaDescriptor};
...
fn compiled_timestamp_registry() -> registry_breg::CompiledRegistry {
...
async fn retain_descriptor(migration: &Client, compiled: &registry_breg::CompiledRegistry) {
