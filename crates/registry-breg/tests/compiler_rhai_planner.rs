...
fn literal(candidate: &registry_breg::rhai_planner::CompiledEffectPlanCandidate) -> &Value {
...
fn rhai_planner_authoring_is_strict_and_compiles_declared_policy() {
    ...
    downgraded.entities[0]
        ...
        .classification = registry_breg::contract::Classification::Public;
    ...
    assert!(registry_breg::contract::parse_project_json(&unknown).is_err());
}
...
fn rhai_planner_authoring_refuses_closed_contract_violations() {
    ...
    for (path, value) in [
        ...
        assert!(
            registry_breg::contract::parse_project_json(&encoded).is_err(),
    ...
    let reference_plan = |script: &str| {
        ...
        write.field_types.insert(
            ...
            FieldTypeSource::Reference {
                ...
                on_delete: registry_breg::contract::ReferenceDelete::Restrict,
            },
        );
        write.reference_sources.insert(
            "label".to_owned(),
            registry_breg::model::CompiledChangeRequestReferenceSources {
