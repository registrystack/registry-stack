...
use registry_breg::model::CompiledEventDelivery;
...
fn mutation_claims(registry: &registry_breg::CompiledRegistry) -> ClaimContext {
...
fn response_etag(outcome: &registry_breg::mutation::MutationOutcome) -> String {
...
authentication:
  oidc:
    ...
    audience: urn:breg:webhook-outbox
