...
use registry_server::contract::{parse_project_yaml, Operation, RequestVisibilitySource};

fn acceptance_project() -> registry_server::contract::RegistryProject {
    let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("../../products/registry-server/acceptance/asset-site-placement-change-requests/registry.yaml");
