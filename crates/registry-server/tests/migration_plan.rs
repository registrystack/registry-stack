...
fn prepare_reviewed_package(
    ...
    previous: CompiledRegistry,
    migrations: Vec<ReviewedMigrationSource>,
) -> registry_server::package::Result<registry_server::package::PreparedPackage> {
