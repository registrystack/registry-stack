...
fn compiled_registry(tombstone: bool) -> registry_server::CompiledRegistry {
...
fn mutation_claims(registry: &registry_server::CompiledRegistry, principal: &str) -> ClaimContext {
