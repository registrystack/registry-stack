...
use crate::contract::{
    ...
    EntityExtensionSource, EntitySource, EventTrigger, FieldSource, FieldTypeSource,
    LookupValueOrigin, ManifestProjectionTextSource, ModuleAssetSource, MutationMode, Operation,
    ReadPathGrantSource, RegistryModule, RegistryProject, UniqueWhenPredicate, ValidTimeRole,
...
use crate::model::{
    ...
    CompiledTemporal, CompiledWebhookDeliveryMode, HttpMethod, MAX_REVISION_HISTORY_RECORDS,
};
