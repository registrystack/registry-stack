...
#[test]
pub(super) fn gate_input_reports_insecure_source_url() {
    let mut config = minimal_config();
...
#[test]
pub(super) fn gate_input_localhost_escape_is_not_an_insecure_url() {
    let mut config = minimal_config();
    config.evidence.source_connections.insert(
        "src".to_string(),
        serde_norway::from_str(
...
#[test]
pub(super) fn gate_input_reports_source_private_network_escape() {
    let mut config = minimal_config();
    config.evidence.source_connections.insert(
        "src".to_string(),
        serde_norway::from_str(
...
#[test]
pub(super) fn gate_input_clears_source_private_network_escape_without_flag() {
    let mut config = minimal_config();
    config.evidence.source_connections.insert(
        "src".to_string(),
        serde_norway::from_str(
...
#[test]
pub(super) fn gate_input_reports_source_adapter_sidecar_without_expected_sidecar() {
    let mut config = minimal_config();
...
#[test]
pub(super) fn gate_input_clears_source_adapter_sidecar_with_expected_sidecar() {
    let mut config = minimal_config();
    let mut conn: SourceConnectionConfig = serde_norway::from_str(
        r#"
base_url: https://source-adapter.example
...
#[test]
pub(super) fn gate_input_reports_insecure_source_url_non_triggering_with_https() {
    let mut config = minimal_config();
    config.evidence.source_connections.insert(
        "src".to_string(),
        serde_norway::from_str(
...
#[test]
pub(super) fn gate_input_reports_source_binding_without_matching_policy() {
    let mut config = minimal_config();
...
#[test]
pub(super) fn gate_input_clears_source_binding_without_matching_policy_with_policy_id() {
    let mut config = minimal_config();
    let mut claim = minimal_claim("residency");
...
#[test]
pub(super) fn gate_input_clears_source_binding_without_matching_policy_with_purpose_gate() {
    let mut config = minimal_config();
    let mut claim = minimal_claim("residency");
    let mut binding = rda_binding("registry_src", "one");
...
#[test]
pub(super) fn gate_input_clears_source_binding_without_matching_policy_with_ecosystem_binding() {
    let mut config = minimal_config();
    let mut claim = minimal_claim("residency");
    let mut binding = rda_binding("registry_src", "one");
...
#[test]
pub(super) fn matching_config_rejects_blank_policy_id() {
    let config: StandaloneRegistryNotaryConfig = serde_norway::from_str(
        r#"
evidence:
  enabled: true
...
#[test]
pub(super) fn matching_context_constraints_deserialize_to_runtime_fields() {
    let config: StandaloneRegistryNotaryConfig = serde_norway::from_str(
        r#"
evidence:
  enabled: true
...
#[test]
pub(super) fn matching_context_constraints_reject_conflicting_flattened_fields() {
    let cases = [
        (
...
#[test]
pub(super) fn matching_context_constraints_nested_allowed_refs_validate_blank_entries() {
...
#[test]
pub(super) fn matching_config_rejects_blank_pdp_policy_entries() {
...
#[test]
pub(super) fn matching_config_rejects_invalid_source_freshness_contract() {
    let ecosystem_bindings = BTreeMap::new();
...
#[test]
pub(super) fn matching_config_selects_governed_ecosystem_binding_metadata() {
...
#[test]
pub(super) fn matching_config_rejects_malformed_or_unsupported_selected_ecosystem_binding() {
...
#[test]
pub(super) fn matching_config_accepts_config_local_ecosystem_binding_selector() {
    let matching = SourceMatchingConfig {
        ecosystem_binding: Some(EcosystemBindingSelectorConfig {
            profile: Some(SUPPORTED_ECOSYSTEM_BINDING_PROFILE.to_string()),
