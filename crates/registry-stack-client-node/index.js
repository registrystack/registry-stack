...
// consumer imports, and `require()` sees the same six properties either way.
...
exports.casework = require('./casework/client');
exports.messaging = require('./messaging/client');
