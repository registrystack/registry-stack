...
/// stops at reservation; the operator paths that mark an expired pending
/// attempt uncertain and settle an uncertain attempt carry no caller at all. The order is the one every event meets except the
