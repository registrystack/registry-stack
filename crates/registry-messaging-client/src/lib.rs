...
//!
//! The client covers the unauthenticated liveness and readiness routes. It
//! never follows redirects or retries, reads every response under a bounded
...
pub use registry_messaging_core::{
    type_uri, ProblemCode, HEALTH_PATH, MESSAGING_PROBLEM_TYPE_BASE, READY_PATH,
};
