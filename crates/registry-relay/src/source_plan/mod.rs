...
pub(crate) use compiler::{
    ...
    open_crvs_no_expiry_script_completion_seed_fixture,
    open_crvs_no_expiry_script_runtime_plan_fixture, open_crvs_runtime_vector_plan_fixture,
    open_crvs_runtime_vector_registry_fixture,
