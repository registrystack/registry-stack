...
class HumanIdentity(TypedDict):
    issuer: str
    subject: str
class ReviewCreateRequest(TypedDict, total=False):
    kind: str
...
class ReviewRequestView(ReviewRequestAccepted, total=False):
    requesterReference: str
    lifecycle: ReviewRequestLifecycle
    activeStage: str
    createdAt: str
    updatedAt: str
class ReviewResult(ReviewRequestAccepted, total=False):
    resultId: str
    ...
    completedAt: str
    availableUntil: str
class ReviewResultOutcome(TypedDict):
    kind: Literal["available", "pending", "concealed_or_unknown", "expired"]
    value: ReviewResult | None
    trace_id: str
...
class ReviewResultFeedEntry(TypedDict):
    ...
    resultId: str
    completedAt: str
class ReviewResultFeedPage(TypedDict, total=False):
    items: list[ReviewResultFeedEntry]
    nextCursor: str
class ReviewCancelRequest(TypedDict):
    subject: ReviewSubjectBinding
    reason: str
ReviewCancelResponse: TypeAlias = JsonObject
class ReviewerTask(TypedDict):
    ...
    state: JsonValue
class ReviewTaskPage(TypedDict, total=False):
...
class ReviewTaskDraft(TypedDict):
    ...
    revision: int
    updatedAt: str
ReviewTaskDecisionRequest: TypeAlias = JsonObject
...
class ReviewHistoryEntry(TypedDict, total=False):
    ...
    detail: JsonValue
    occurredAt: str
class ReviewHistoryPage(TypedDict, total=False):
...
class CaseworkClient:
    ...
    def review_request(self, token: str, profile: str, request_id: str) -> Complete[ReviewRequestView]: ...
    ...
    def cancel_review_request(self, token: str, profile: str, request_id: str, idempotency_key: str, request: ReviewCancelRequest) -> Complete[ReviewCancelResponse]: ...
    ...
    def review_task(self, token: str, profile: str, task_id: str, source_profile: str | None = None) -> Complete[ReviewerTask]: ...
    def review_task_context(self, token: str, profile: str, task_id: str, source_profile: str | None = None) -> Complete[ReviewTaskContext]: ...
    def preview_review_task_templates(self, token: str, profile: str, source_profile: str, task_id: str) -> Complete[TaskTemplatePreviews]: ...
    def list_review_task_grants(self, token: str, profile: str, source_profile: str, task_id: str) -> Complete[TaskGrantList]: ...
    def approve_review_task_grant(self, token: str, profile: str, source_profile: str, task_id: str, expected_revision: int, idempotency_key: str, approval: TaskApprovalRequest) -> Complete[TaskGrantView]: ...
    def revoke_review_task_grant(self, token: str, profile: str, task_id: str, grant_id: str) -> Complete[TaskGrantRevocation]: ...
    def claim_review_task(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str, source_profile: str | None = None) -> Complete[ReviewerTask]: ...
    def release_review_task(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str) -> Complete[ReviewerTask]: ...
    def assign_review_task(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str, request: AssignmentRequest, source_profile: str | None = None) -> Complete[ReviewerTask]: ...
    def delegate_review_task(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str, request: DelegateRequest, source_profile: str | None = None) -> Complete[ReviewerTask]: ...
    def review_task_draft(self, token: str, profile: str, task_id: str, source_profile: str | None = None) -> Complete[ReviewTaskDraft | None]: ...
    def save_review_task_draft(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str, draft: ReviewTaskDraftInput, source_profile: str | None = None) -> Complete[ReviewTaskDraft]: ...
    def delete_review_task_draft(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str, source_profile: str | None = None) -> Complete[None]: ...
    def decide_review_task(self, token: str, profile: str, task_id: str, expected_revision: int, idempotency_key: str, decision: ReviewTaskDecisionRequest, source_profile: str | None = None) -> Complete[None]: ...
    def review_history(self, token: str, profile: str, request_id: str, query: ReviewPageQuery | None = None, source_profile: str | None = None) -> Complete[ReviewHistoryPage]: ...
    def add_review_note(self, token: str, profile: str, request_id: str, idempotency_key: str, note: ReviewNoteRequest, source_profile: str | None = None) -> Complete[ReviewHistoryEntry]: ...
    def review_clocks(self, token: str, profile: str, request_id: str, source_profile: str | None = None) -> Complete[list[JsonValue]]: ...
    def review_accountability(self, token: str, profile: str, event_id: str) -> Complete[ReviewAccountabilityRecord]: ...
    ...
    def task_assertion_endpoint(self, grant_id: str) -> str: ...
