...
and decisions accept an optional source profile only when resolving source
context. Assignment, delegation, drafts, history, notes, accountability, and
kind discovery remain Casework-owned authorization paths.
