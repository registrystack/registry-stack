...
impl ProblemCode {
    ...
    pub const fn status(self) -> StatusCode {
        match self {
            ...
            Self::ClockRecomputePreviewExpired | Self::ReviewResultExpired => StatusCode::GONE,
...
const REVIEW_TASK_READ: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::OperationNotAuthorized,
    ProblemCode::ProfileNotAuthorized,
    ProblemCode::ProfileNotHuman,
...
const REVIEW_TASK_HELD_READ: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::OperationNotAuthorized,
    ProblemCode::ProfileNotAuthorized,
    ProblemCode::ProfileNotHuman,
...
const REVIEW_TASK_CLAIM: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::IdempotencyExpired,
    ProblemCode::IdempotencyKeyReused,
    ProblemCode::OperationNotAuthorized,
...
const REVIEW_TASK_RELEASE: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::IdempotencyExpired,
    ProblemCode::IdempotencyKeyReused,
    ProblemCode::OperationNotAuthorized,
...
const REVIEW_TASK_ASSIGNMENT: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::IdempotencyExpired,
    ProblemCode::IdempotencyKeyReused,
    ProblemCode::OperationNotAuthorized,
...
const REVIEW_TASK_DRAFT_MUTATION: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::IdempotencyExpired,
    ProblemCode::IdempotencyKeyReused,
    ProblemCode::OperationNotAuthorized,
...
const REVIEW_TASK_DECISION: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::IdempotencyExpired,
    ProblemCode::IdempotencyKeyReused,
    ProblemCode::OperationNotAuthorized,
...
const TASK_AUTHORITY: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::OperationNotAuthorized,
    ProblemCode::ProfileNotAuthorized,
    ProblemCode::ProfileNotHuman,
...
const TASK_APPROVAL: &[ProblemCode] = &[
    ProblemCode::AuthenticationRefused,
    ProblemCode::OperationNotAuthorized,
    ProblemCode::ProfileNotAuthorized,
    ProblemCode::ProfileNotHuman,
...
pub const OPERATION_CONTRACTS: &[OperationContract] = &[
    OperationContract {
        ...
        accepts_json: false,
        problems: &[ProblemCode::WorkItemNotVisible, ProblemCode::RuntimeFailure],
    },
    OperationContract {
        method: "GET",
        path: "/v1/work-items/{item_id}/task-templates",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
        problems: TASK_AUTHORITY,
    },
    OperationContract {
        method: "GET",
    ...
    OperationContract {
        ...
        extracts_query: false,
        accepts_json: true,
        problems: TASK_APPROVAL,
    },
    OperationContract {
        method: "POST",
        path: "/v1/work-items/{item_id}/task-grants/{grant_id}/revoke",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/task-grants/{grant_id}/assertion",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/task-grants/{grant_id}/status",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-kinds",
        success_statuses: &[200],
        extracts_path: false,
        extracts_query: false,
        accepts_json: false,
        problems: REVIEW_KIND_READ,
    },
    OperationContract {
        method: "GET",
        path: "/v1/review-kinds/{kind_id}",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-requests/{request_id}",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-requests/{request_id}/cancel",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: true,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-requests/{request_id}/result",
        success_statuses: &[200, 202, 404, 410],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
        problems: REVIEW_PRODUCER,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-requests/{request_id}/clocks",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-tasks/{task_id}/claim",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
        problems: REVIEW_TASK_CLAIM,
    },
    OperationContract {
        method: "GET",
    ...
    OperationContract {
        ...
        extracts_query: false,
        accepts_json: false,
        problems: REVIEW_TASK_READ,
    },
    OperationContract {
        method: "GET",
        path: "/v1/review-tasks/{task_id}/context",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-tasks/{task_id}/task-templates",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-tasks/{task_id}/task-grants",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-tasks/{task_id}/task-grants/{grant_id}/revoke",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-tasks/{task_id}/assign",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: true,
        problems: REVIEW_TASK_ASSIGNMENT,
    },
    OperationContract {
        method: "POST",
        path: "/v1/review-tasks/{task_id}/delegate",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: true,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-tasks/{task_id}/release",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
        problems: REVIEW_TASK_RELEASE,
    },
    OperationContract {
        method: "GET",
        path: "/v1/review-tasks/{task_id}/draft",
        success_statuses: &[200, 404],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
        problems: REVIEW_TASK_HELD_READ,
    },
    OperationContract {
        method: "PUT",
        path: "/v1/review-tasks/{task_id}/draft",
        ...
        extracts_query: false,
        accepts_json: true,
        problems: REVIEW_TASK_DRAFT_MUTATION,
    },
    OperationContract {
        method: "DELETE",
        path: "/v1/review-tasks/{task_id}/draft",
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-tasks/{task_id}/decisions",
        success_statuses: &[204],
        extracts_path: true,
        extracts_query: false,
        accepts_json: true,
        problems: REVIEW_TASK_DECISION,
    },
    OperationContract {
        method: "GET",
        path: "/v1/review-requests/{request_id}/history",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: true,
        accepts_json: false,
    ...
    OperationContract {
        method: "POST",
        path: "/v1/review-requests/{request_id}/notes",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: true,
    ...
    OperationContract {
        method: "GET",
        path: "/v1/review-accountability/{event_id}",
        success_statuses: &[200],
        extracts_path: true,
        extracts_query: false,
        accepts_json: false,
