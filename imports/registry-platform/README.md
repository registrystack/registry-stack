...
- Versioning: all crates currently share the workspace version `0.3.2`.
- Signing support: v0.3.2 supports EdDSA/Ed25519 for platform-owned signing and
...
```toml
[dependencies]
registry-platform-httputil = { git = "https://github.com/jeremi/registry-platform", tag = "v0.3.2" }
registry-platform-oidc = { git = "https://github.com/jeremi/registry-platform", tag = "v0.3.2" }
```
