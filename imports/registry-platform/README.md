...
| [`registry-platform-sts`](crates/registry-platform-sts/README.md) | RegistryStack STS bridge for minting Notary-bound transaction tokens from verified subject tokens. |
...
- Versioning: all crates currently share the workspace version `0.3.3`.
- Signing support: v0.3.3 supports EdDSA/Ed25519 for platform-owned signing and
...
```toml
[dependencies]
registry-platform-httputil = { git = "https://github.com/jeremi/registry-platform", tag = "v0.3.3" }
registry-platform-oidc = { git = "https://github.com/jeremi/registry-platform", tag = "v0.3.3" }
```
