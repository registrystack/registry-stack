...
- [OpenFn sidecar egress hardening](openfn-sidecar-egress-hardening.md): required network-layer egress controls for the OpenFn engine path — Kubernetes NetworkPolicy and egress-proxy options, IP range reference, and verification checklist.
