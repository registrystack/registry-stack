        ...
        "paths": {
            ...
            "/.well-known/openid-credential-issuer": {
                "get": {
                    ...
                    "description": "Returns the OpenID4VCI issuer metadata for Registry Witness' dc+sd-jwt issuance profile.",
                    "security": [],
                    "responses": {
                        "200": {
    ...
    fn assert_problem_example(doc: &serde_json::Value, path: &str, method: &str, status: &str) {
        ...
        assert!(
            example["type"]
                .as_str()
                .is_some_and(|value| {
                    value.starts_with("https://docs.registry-witness.dev/problems/")
                }),
