...
export CEL_MAPPING_SOURCE_DIR="${CEL_MAPPING_SOURCE_DIR:-"${demo_dir}/../cel-mapping"}"
export REGISTRY_OPENFN_WITNESS_SOURCE_DIR="${REGISTRY_OPENFN_WITNESS_SOURCE_DIR:-"${REGISTRY_WITNESS_SOURCE_DIR}"}"
