...
# Start split source-registry and Registry Notary processes, run the narrated demo, then stop them.
notary-demo:
    uv run demo/scripts/registry_notary_demo.py --start-server
