...
- `REGISTRY_RELAY_TOKEN_CLAIM_VERIFICATION` (generated by `generate_perf_keys.py`)
...
- The `claim_verification:` and `provenance:` blocks in `perf/config/*.yaml`
...
`benches/claim_verification_bench.rs` covers the hot path in isolation:
