...
- The Registry Relay OpenAPI artifact is a `hand-authored-abstract-contract`; see [API references provenance and freshness](/reference/apis/) for detail on what that means and how to get an instance-specific shape.
