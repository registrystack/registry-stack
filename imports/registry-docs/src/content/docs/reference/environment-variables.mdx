...
The fixed variable names above are transcribed from the binaries and the registryctl source. For the canonical definitions, read the [Registry Notary binary entry point](https://github.com/jeremi/registry-notary/blob/a742933b5f4d15b0fed3f7f4089943d1a400987a/crates/registry-notary-bin/src/main.rs), the [Registry Relay binary entry point](https://github.com/jeremi/registry-relay/blob/f00ffad8a12512104b4bd80e4639444e8baf90c8/src/main.rs), and the [registryctl library source](https://github.com/jeremi/registry-registryctl/blob/v0.2.0/src/lib.rs). The operator-named secret variables are documented in the [Registry Notary operator config reference](../../products/registry-notary/operator-config-reference/) and the [Registry Relay configuration reference](../../products/registry-relay/configuration/).
