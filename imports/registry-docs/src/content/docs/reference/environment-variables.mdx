...
The fixed variable names above are transcribed from the binaries and the registryctl source. For the canonical definitions, read the [Registry Notary binary entry point](https://github.com/jeremi/registry-notary/blob/50f8ffe04cd9b1cf1986f5742b6bf450642dab03/crates/registry-notary-bin/src/main.rs), the [Registry Relay binary entry point](https://github.com/jeremi/registry-relay/blob/384d95795881a3ce6000cea6219c89353dfa5119/src/main.rs), and the [registryctl library source](https://github.com/jeremi/registry-registryctl/blob/v0.2.0/src/lib.rs). The operator-named secret variables are documented in the [Registry Notary operator config reference](../../products/registry-notary/operator-config-reference/) and the [Registry Relay configuration reference](../../products/registry-relay/configuration/).
