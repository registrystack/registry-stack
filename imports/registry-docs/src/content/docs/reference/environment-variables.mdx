...
The fixed variable names above are transcribed from the binaries and the registryctl source. For the canonical definitions, read the [Registry Notary binary entry point](https://github.com/jeremi/registry-notary/blob/main/crates/registry-notary-bin/src/main.rs), the [Registry Relay binary entry point](https://github.com/jeremi/registry-relay/blob/main/src/main.rs), and the [registryctl library source](https://github.com/jeremi/registry-registryctl/blob/main/src/lib.rs). The operator-named secret variables are documented in the [Registry Notary operator config reference](../../products/registry-notary/operator-config-reference/) and the [Registry Relay configuration reference](../../products/registry-relay/configuration/).
