...
The fixed variable names above are transcribed from the binaries and the registryctl source. For the canonical definitions, read the [Registry Notary binary entry point](https://github.com/jeremi/registry-notary/blob/c845d7b204af3e86a9fc515b1f347177cea490cb/crates/registry-notary-bin/src/main.rs), the [Registry Relay binary entry point](https://github.com/jeremi/registry-relay/blob/256d281829a502725ca2b327c24b444f66126122/src/main.rs), and the [registryctl library source](https://github.com/jeremi/registry-registryctl/blob/v0.2.0/src/lib.rs). The operator-named secret variables are documented in the [Registry Notary operator config reference](../../products/registry-notary/operator-config-reference/) and the [Registry Relay configuration reference](../../products/registry-relay/configuration/).
