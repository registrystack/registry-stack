...
It documents the full route surface using templated paths (`/v1/datasets/{dataset_id}/entities/{entity}/...`) and capability tags, rather than enumerating one deployment's datasets and entities.
