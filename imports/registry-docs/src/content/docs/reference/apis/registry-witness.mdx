...
Default bind: `127.0.0.1:8081`. The standalone demo config (`demo/config/registry-witness.yaml`) overrides this to `127.0.0.1:4255`. The Registry Lab topology overrides it to `0.0.0.0:8080` inside the container (mapped to host ports 4321-4324).
