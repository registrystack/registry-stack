...
Evidence source: [Registry Witness](../../../projects/registry-witness/) `main` commit `526e0a6a94ded74e210e510d6caf43b6a32eb5ce`, generated after the `v0.2.1` release and reviewed 2026-05-24.
...
and the protected admin reload route mounted by the standalone router.
