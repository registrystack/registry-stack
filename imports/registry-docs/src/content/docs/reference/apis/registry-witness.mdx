...
Evidence source: [Registry Witness](../../../projects/registry-witness/) commit `813c1870a1e8611e78c5740a9ccf4954e98c20b4`, reviewed 2026-05-24.
...
{/* The upstream generator includes the Apache-2.0 info.license block required by Redocly. */}
...
The pinned OpenAPI document is titled "Registry Witness API" at version `0.2.1`.
Routes are defined in `crates/registry-witness-server/src/api.rs`.
The generated OpenAPI artifact covers public probe routes, protected API routes, and the protected admin no-op route.
