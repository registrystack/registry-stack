...
The codes above are transcribed from the error taxonomies in the owning repos. For the canonical definitions, read the [Registry Notary `EvidenceError` taxonomy](https://github.com/jeremi/registry-notary/blob/4fb5fcf137edb628f3dc4bfedd42891dbbdebb03/crates/registry-notary-core/src/error.rs) and the [Registry Relay error taxonomy](https://github.com/jeremi/registry-relay/blob/917e8064b62b8f86f35425a61fe66d3a4b5db921/src/error.rs).
