...
The codes above are transcribed from the error taxonomies in the owning repos. For the canonical definitions, read the [Registry Notary `EvidenceError` taxonomy](https://github.com/jeremi/registry-notary/blob/c845d7b204af3e86a9fc515b1f347177cea490cb/crates/registry-notary-core/src/error.rs) and the [Registry Relay error taxonomy](https://github.com/jeremi/registry-relay/blob/256d281829a502725ca2b327c24b444f66126122/src/error.rs).
