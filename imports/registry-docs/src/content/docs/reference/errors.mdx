...
The codes above are transcribed from the error taxonomies in the owning repos. For the canonical definitions, read the [Registry Notary `EvidenceError` taxonomy](https://github.com/jeremi/registry-notary/blob/18b30ec45086a12d8b518eca9bfe838c7cff780e/crates/registry-notary-core/src/error.rs) and the [Registry Relay error taxonomy](https://github.com/jeremi/registry-relay/blob/256d281829a502725ca2b327c24b444f66126122/src/error.rs).
