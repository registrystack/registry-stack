...
The codes above are transcribed from the error taxonomies in the owning repos. For the canonical definitions, read the [Registry Notary `EvidenceError` taxonomy](https://github.com/jeremi/registry-notary/blob/a742933b5f4d15b0fed3f7f4089943d1a400987a/crates/registry-notary-core/src/error.rs) and the [Registry Relay error taxonomy](https://github.com/jeremi/registry-relay/blob/f00ffad8a12512104b4bd80e4639444e8baf90c8/src/error.rs).
