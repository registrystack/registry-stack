...
| --- | --- | --- |
| Describe registries | Other teams need to inspect fields, schemas, policies, services, and evidence offerings before integration. | [Registry Manifest](../../products/registry-manifest/) |
...
[Registry Atlas](../../products/registry-atlas/) inspects what a registry actually publishes before
an integration is built, by reading the generated metadata artifacts and running strict capability
queries against known machine terms.
Shared audit and operational behavior makes Registry Relay and Registry Notary reviewable:
[Registry Platform](../../products/registry-platform/) supplies the shared primitives for
authentication, HTTP security, audit envelopes, cryptography, and credential support that both
