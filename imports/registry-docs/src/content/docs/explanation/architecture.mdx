...
These docs document the two runtime products you build against directly, Registry Relay and Registry
Notary. Registry Manifest, Registry Atlas, Registry Platform, and Registry Lab are part of the wider
stack; see [registrystack.org](https://registrystack.org/) for them.
...
| --- | --- | --- |
| Describe registries | Other teams need to inspect fields, schemas, policies, services, and evidence offerings before integration. | [Registry Manifest](https://registrystack.org/) |
