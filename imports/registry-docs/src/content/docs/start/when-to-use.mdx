...
These docs cover Registry Relay and Registry Notary; the other surfaces are part of the wider stack
described at [registrystack.org](https://registrystack.org/). For how the pieces connect at runtime,
