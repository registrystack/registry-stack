...
description: Reference for the shared Registry Platform crates and the consumer responsibilities they leave to Relay, Notary, and operators.
status: draft
...
Local development in this workspace currently uses sibling path dependencies beside Relay and Notary.
...
- [Registry Notary Cargo.toml](https://github.com/jeremi/registry-notary/blob/main/Cargo.toml)
