...
description: Registry Manifest turns a single YAML metadata manifest into standards-facing artifacts and public Notary federation metadata a registry needs to publish, validate, and share.
status: current
