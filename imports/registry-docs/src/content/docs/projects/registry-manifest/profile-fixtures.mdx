...
For basic manifest validation (schema version, field format, reference integrity), use the `validate` subcommand instead. See the [validate-and-render how-to](../validate-and-render/).
