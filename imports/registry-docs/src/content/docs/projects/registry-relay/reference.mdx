...
audit record fields, environment variables, and startup error codes for Registry Relay v0.1.0.
...
Source: [docs/configuration.md](https://github.com/jeremi/registry-relay/blob/aec4394300c87e1f0e93b73580c9b12150552111/docs/configuration.md) (root shape; all keys below are documented there unless otherwise noted).
...
| `metadata` | object | no | Path to a portable `metadata.yaml` manifest (split config); see [docs/metadata.md](https://github.com/jeremi/registry-relay/blob/aec4394300c87e1f0e93b73580c9b12150552111/docs/metadata.md) |
