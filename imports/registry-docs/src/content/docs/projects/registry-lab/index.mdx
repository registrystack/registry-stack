...
description: Registry Lab is the Docker Compose demo for the registry stack, wiring Relay, Notary, live-source, OpenFn, static metadata, and narrated demo services into a single topology you can run on a laptop.
status: current
owner: registry-lab
source_repos:
  - registry-lab
...
It wires three Registry Relay instances, four Registry Notary instances,
...
The topology runs three Relay instances, four Notary instances, live Postgres and Zitadel services,
