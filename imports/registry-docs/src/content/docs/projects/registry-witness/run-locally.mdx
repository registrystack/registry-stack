...
Registry Witness starts fail-closed: no protected route is served unless static credentials or OIDC auth are configured.
...
The demo config expects `REGISTRY_WITNESS_API_KEY_HASH` and `REGISTRY_WITNESS_BEARER_TOKEN_HASH`.
