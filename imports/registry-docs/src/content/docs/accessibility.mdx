...
The design decisions that back these commitments are in
[`design-registry-legend.md`](https://github.com/jeremi/registry-legend/blob/main/design-registry-legend.md).
...
A skip-link is present on the implemented version to bypass repeated navigation.
