---
title: Accessibility
description: Accessibility commitments for the Registry Docs documentation site.
status: current
owner: registry-docs
source_repos: []
...
The design decisions that back these commitments are in [`design-registry-docs.md`](https://github.com/jeremi/registry-docs/blob/main/design-registry-docs.md).
