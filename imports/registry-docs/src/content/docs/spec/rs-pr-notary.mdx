...
- Delegated self-attestation access modes, source capabilities, stored metadata, and denial reasons are implemented in [`model.rs`](https://github.com/jeremi/registry-notary/blob/de16328c4901de00390c62e94a64df4e504e2436/crates/registry-notary-core/src/model.rs).
- Delegated relationship configuration validation is implemented in [`config.rs`](https://github.com/jeremi/registry-notary/blob/de16328c4901de00390c62e94a64df4e504e2436/crates/registry-notary-core/src/config.rs).
- Request context derivation, stored-evaluation revalidation, OID4VCI delegated-token rejection, explicit target binding, and proof-gated source reads are implemented in [`api.rs`](https://github.com/jeremi/registry-notary/blob/de16328c4901de00390c62e94a64df4e504e2436/crates/registry-notary-server/src/api.rs) and [`runtime.rs`](https://github.com/jeremi/registry-notary/blob/de16328c4901de00390c62e94a64df4e504e2436/crates/registry-notary-server/src/runtime.rs).
