...
This is a maintenance record. If you're an integrator using the current project names (Registry Relay, Registry Witness, and the rest of the stack), you can ignore the legacy column.
