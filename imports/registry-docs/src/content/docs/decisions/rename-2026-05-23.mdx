...
This is a maintenance record. If you're an integrator using the current project names (Registry Relay, Registry Witness, etc.), you can ignore the legacy column.
