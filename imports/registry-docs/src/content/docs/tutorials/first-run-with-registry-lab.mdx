...
configured in
[`config/notary/shared-eligibility-notary.yaml`](https://github.com/jeremi/registry-lab/blob/b4cc8eb37456d65003481929c48955e9a8eb7fb9/config/notary/shared-eligibility-notary.yaml).
