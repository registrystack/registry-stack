...
<QuickstartMeta
  ...
  prerequisites={['registryctl 0.1.0+', 'A Docker Compose provider', 'curl, tar']}
/>
...
It defaults to `v0.2.0` in the beta-3 release.
...
```sh
cargo install --git https://github.com/jeremi/registry-registryctl --tag v0.2.0 --locked
```
