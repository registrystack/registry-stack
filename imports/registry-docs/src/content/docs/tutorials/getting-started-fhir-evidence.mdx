...
Use this tutorial when you want to see how Registry Notary can evaluate claims
from FHIR-shaped health data. You will run the Registry Lab FHIR profile, call
the Notary evaluation API, and inspect the claim results produced from a local
FHIR R4 fixture server.
...
Clone Registry Lab if you do not already have it:
