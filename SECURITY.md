...
- The asset, for example `registryctl-v0.15.0-linux-amd64`
- The matching signature, for example `registryctl-v0.15.0-linux-amd64.sig`
- The matching certificate, for example `registryctl-v0.15.0-linux-amd64.pem`

Then verify the asset:

```bash
asset=registryctl-v0.15.0-linux-amd64
