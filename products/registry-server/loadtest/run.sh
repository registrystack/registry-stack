...
usage() {
  printf '%s\n' "usage: products/registry-server/loadtest/run.sh --profile steady|sweep|burst|herd|token-soak|cursor-smoke [--ops N] [--duration 10m] [extra k6 args]" >&2
  exit 2
}
