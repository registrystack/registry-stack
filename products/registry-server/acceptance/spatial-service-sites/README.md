...
This is a neutral synthetic Registry Server source fixture for the first Server GIS increment. It models one `service-site` entity with a CRS84 GeoJSON Point field named `location`, public map attributes, an optional null geometry case and a reviewed derived logical `map-label` attribute.
