...
Registry Server can expose a stored CRS84 Point as GeoJSON and grant bounded
...
Run `registry-serverctl doctor --runtime-config /absolute/path/to/runtime.yaml`
