...
class GeneratedGateTests(unittest.TestCase):
    ...
    def test_change_request_examples_script_uses_protected_runtime_files(self) -> None:
        ...
        self.assertIn("REGISTRY_SERVER_TEST_DATABASE_URL", script)
        self.assertIn("REGISTRY_SERVER_TEST_TLS_CA_PEM_PATH", script)
        ...
        self.assertIn("registry-serverctl", script)
        ...
        self.assertNotIn("REGISTRY_SERVER_TEST_DATABASE_URL=", script)
