...
- Mint and the [OID4VCI adapter](../../crates/registry-evidence-oid4vci/AGENTS.md)
  are supporting services. Evidence has no runtime dependency on them. Reuse
  platform primitives where their contracts fit directly.
