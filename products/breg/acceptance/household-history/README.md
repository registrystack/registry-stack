...
This fixture exercises Base Registry Engine correction and historical snapshot behavior
...
- `BREG_TEST_DATABASE_URL`: the disposable administrator connection.
- `BREG_TEST_TLS_CA_PEM_PATH`: the absolute path to its PEM CA
