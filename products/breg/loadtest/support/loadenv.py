#!/usr/bin/env python3
"""Helpers for the Base Registry Engine load-test environment.
...
driver client (the k6 harness), and Base Registry Engine serving the
...
SCHEMA_TEST_CREDENTIALS = """apiVersion: registry.registrystack.org/breg-schema-test-credentials/v1
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(description="Base Registry Engine load-test environment helpers")
    ...
    prepare_command.add_argument("--breg-port", type=int, required=True)
