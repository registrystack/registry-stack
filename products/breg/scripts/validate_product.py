...
POSTGRES_TEST_COMMANDS = (
    "cargo test --locked -p registry-breg --features runtime --test http_auth",
    "cargo test --locked -p registry-breg --features runtime --test http_read_only",
    "cargo test --locked -p registry-breg --features runtime --test runtime_config",
    "cargo test --locked -p registry-breg --features runtime --test startup_http",
    "cargo test --locked -p registry-breg --features runtime --test startup_ordering",
    "cargo test --locked -p registry-breg --features runtime,tooling --test fixture_tooling",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_kernel",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_compiled_schema",
    ...
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_anonymous_refusals",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_history_commit",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_historical",
    "cargo test --locked -p registry-breg --features postgres-test,tooling --test postgres_history_migration",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_history_erasure",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_history_rebaseline",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_workspace_metadata",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_mutation",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_mutation_logical_names",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_immediate_actions",
    "cargo test --locked -p registry-breg --features postgres-test,tooling --test postgres_immediate_action_examples",
    ...
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_consent_access",
    "cargo test --locked -p registry-breg --features postgres-test,tooling --test postgres_consent_examples",
    ...
    "cargo test --locked -p registry-breg --features postgres-test,tooling --test postgres_action_evidence_retention",
    ...
    "cargo test --locked -p registry-breg --features postgres-test,tooling --test postgres_fixture_journeys",
    "cargo test --locked -p registry-breg --features postgres-test,tooling --test schema_fingerprint_rehearsal",
    "cargo test --locked -p registry-breg --features postgres-test --test postgres_startup",
)
