...
SECURITY_INVARIANT_IDS = tuple(f"BREG-SEC-{index:02d}" for index in range(1, 50))
ACCEPTANCE_FIXTURES = {
...
def validate_acceptance(errors: list[str]) -> set[str]:
    ...
    if ordered_identifiers != list(ACCEPTANCE_JOURNEY_IDS):
        errors.append("acceptance matrix: must contain BREG-J01 through BREG-J19 exactly once in order")
