...
SPEC = importlib.util.spec_from_file_location("breg_demo", MODULE_PATH)
...
class DemoProvisioningTests(unittest.TestCase):
    ...
    def test_prepare_binds_mint_authority_static_jwks_and_secret_database_urls(self) -> None:
        ...
        self.assertIn("audiences: [urn:breg:business-demo]", mint)
        ...
        self.assertIn("apiVersion: registry.registrystack.org/breg-runtime/v1alpha1", runtime)
        self.assertIn("kind: BRegRuntimeConfig", runtime)
    ...
    def test_prepare_household_remains_explicit_legacy_demo_fixture(self) -> None:
        ...
        self.assertIn("audience: urn:breg:household-demo", runtime)
    ...
    def test_handoff_contains_only_frozen_persona_metadata_and_owner_only_token_paths(self) -> None:
        (self.root / "breg-origin").write_text("http://127.0.0.1:18080\n", encoding="ascii")
        expires = 1798761600
    ...
    def test_change_request_handoff_carries_only_an_inert_record_path_and_persona_order(self) -> None:
        (self.root / "breg-origin").write_text(
